...
namespace Persistence.Migrations
{
    ...
    [Migration("20260812100525_AddPaymentOriginatedLedgerCredits")]
    partial class AddPaymentOriginatedLedgerCredits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ChargeCycleShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChargeCycleId", "UserId")
                        .IsUnique();

                    b.ToTable("ChargeCycleShares");
                });
            ...
            modelBuilder.Entity("Domain.Entities.HouseNoteItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SectionId", "IsCompleted", "DeletedAt");

                    b.ToTable("HouseNoteItems");
                });

            modelBuilder.Entity("Domain.Entities.HouseNoteSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HouseId", "DeletedAt", "Title");

                    b.ToTable("HouseNoteSections");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Receipt", b =>
                {
                    ...
                    b.Property<int?>("ConvertedExpenseId")
                        .HasColumnType("int");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("DetectedTotalAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("HouseId", "UploadedByUserId", "CreatedAt");
            ...
            modelBuilder.Entity("Domain.Entities.ReceiptItem", b =>
                {
                    ...
                    b.Property<int?>("BoxLeft")
                        .HasColumnType("int");

                    b.Property<int?>("BoxTop")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.RecurringCharge", b =>
                {
                    ...
                    b.Property<int>("AccountingMode")
                        .HasColumnType("int");

                    b.Property<int>("AmountMode")
                        .HasColumnType("int");

                    b.Property<int>("CollectionStartDay")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ChargeCycleShare", b =>
                {
                    b.HasOne("Domain.Entities.ChargeCycle", "ChargeCycle")
                        .WithMany("Shares")
                        .HasForeignKey("ChargeCycleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChargeCycle");
                });
            ...
            modelBuilder.Entity("Domain.Entities.HouseNoteItem", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.HouseNoteSection", "Section")
                        .WithMany("Items")
